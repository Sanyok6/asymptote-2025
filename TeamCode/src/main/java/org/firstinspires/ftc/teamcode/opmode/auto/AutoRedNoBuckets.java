...
public class AutoRedNoBuckets extends LinearOpMode {
    public void runOpMode() {
        ...
        Pose2d beginPose = new Pose2d(8.8, -61.4, Math.toRadians(0));
     ...
     Actions.runBlocking(
        drive.actionBuilder(beginPose)
                ...
                .splineToLinearHeading(new Pose2d(63,-13,Math.PI/2), -Math.PI/2)
                .waitSeconds(1)
                .setTangent(-Math.PI/2)
                .lineToY(-45)
                .setTangent(-Math.PI/2)
...
//Parking for no Buckets
                ...
                .splineToLinearHeading(new Pose2d(68,-13,Math.PI/2), -Math.PI/2)
                .waitSeconds(1)
                .lineToY(-55)
               // .waitSeconds()
                .splineToLinearHeading(new Pose2d(68,-13,Math.PI/2), -Math.PI/2)
