...
@Config
@Autonomous(name = "5PIECESBUCKET", group = "Autonomous")
public class FIVEPIECEBUCKETS extends LinearOpMode {
    public void runOpMode() {
        ...
        Action traj = drive.actionBuilder(beginPose)
                ...
                .setTangent(Math.toRadians(182.5))
                .afterTime(0.25, () -> {
                    scoringMechanism.horizontalSlide.setTargetPosition(150);
                    scoringMechanism.setPosition(ScoringMechanismPosition.INTAKE_LOWER);
                    scoringMechanism.intake.runIntake();
                ...
                .splineToLinearHeading(new Pose2d(20,38 , Math.toRadians(180)), Math.toRadians(0))
